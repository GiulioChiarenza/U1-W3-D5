...
*/ 
let propietà = Object.keys(me)
delete me[propietà.pop()]
console.log(me)
...
let text = 'i study in epicode'
let result = splitMe(text)
console.log(result)
...
/* ESERCIZIO 4
 ...
 const isThisAnEmail = function(string){
   let prova = /^[^\s@]+@[^\s@]+\.[^\s@]+$/
   return prova.test(string)
  }
  console.log(isThisAnEmail('email@exemple.com'))
...
// const howManyDays = function(data){
 ...
 const isTodayMyBirthday = function(){
   const myBirthday = new Date('1997-11-14')
   return (now.getMonth() === myBirthday.getMonth()) && (now.getDate() === myBirthday.getDate())
  } 
...
*/
const deleteProp = function(oggetto, string){
if (string in oggetto) {
...
// return movies.Title.includes(string)
// }
...
*/
const background =document.getElementsByTagName('link')
background.style.backgroundColor= 'red'
/* ESERCIZIO 24
  Scrivi una funzione per aggiungere un nuovo elemento alla lista non ordinata con id "myList".
*/
const addNewElement = function(text){
  const newElement = document.createElement('li')
  newElement.textContent = ciao
  const addElement = document.getElementById('my list')
